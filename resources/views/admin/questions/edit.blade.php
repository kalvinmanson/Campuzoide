...
@section('content')
    <h1>Questions: Edit {{ $question->name }}</h1>
        ...
        <div class="row mt-2">
            ...
            <div class="col-sm-8">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="tags" name="tags" placeholder="Palabras clave separadas por comas." value="{{ old('tags') ? old('tags') : $question->tags }}">
                </div>
            </div>
        </div>
        <div class="form-group">
